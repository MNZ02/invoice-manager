...
router.put('/invoices/:id', authenticateUser, invoiceController.updateInvoiceById);

// Delete invoice by ID
router.delete('/invoices/:id', authenticateUser, invoiceController.deleteInvoiceById);
